...
function [hX2r, V2a, loadsa,Meansmo2b,Da,mx,my] = fpca_gpu(L,Fc,x1minc,x2minc,x1maxc,x2maxc,cgridx,cgridy,c5unil,c2unil,c3unil,c3unilr,N,mx,my,method,comp,sigma,app)
L   =L-1; 
mxe =mx;
mye =my;
