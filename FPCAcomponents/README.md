...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **FPCAcomponents** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
Description : 'It interpolates the estimated functional components at a common grid and plots them,
together with the estimates loadings time series.'

Keywords : 'estimation, FPCA, call prices, derivative, density, state price density, risk neutral
density, functional components, time series, loadings'
